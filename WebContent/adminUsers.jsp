        ...
        <div id="main">
            <form id="form">
                ...
                <div class="search_add">
                    ...
                    <a>${status }</a>
                    <input type="button" value="已启用账户" onclick="location.href='adminAction_findAllSu?page.currentpage=1'" style="font-size: xx-small;line-height:2px;padding: 0 10px;" class="button button-glow button-border button-rounded button-primary"/>
                    <input type="button" value="已冻结账户" onclick="location.href='adminAction_findAllFreeze?page.currentpage=1'" style="font-size: xx-small;line-height:2px;padding: 0 10px;" class="button button-glow button-border button-rounded button-primary"/>
                </div> 
                <!--数据区域：用表格展示数据-->     
                <div id="data">            
                    <table id="datalist" style="margin-top: 16px;">
                        ...
                        <tr>
						    ...
						    <td>
						    	<input type="button" value="${salary }" onclick="updatestatus('${a.username}','allAccount')" style="font-size: xx-small;line-height:2px;padding: 0 10px;" class="button button-glow button-border button-rounded button-primary">

				        
						    	</input>
						    </td>
			   			    <td>
			   			    	<img src="images/delete.png" onclick="del(${a.accountid},'allAccount');"/>
			   			    </td>
                        </tr>
                        </c:forEach>
                    </table>
