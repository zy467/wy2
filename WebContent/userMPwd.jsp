...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <!--主要区域开始-->
        <div id="main">
            <form action="action_userMPwd" method="post" id="allow">
            <div id="mpwd">
			<table>
                <tr>
                    <td class="login_info" style="font-size: large;">当前密码：</td>
                    <td colspan="2"><input name="pwd.oldpwd" type="password" class="width150" id="oldpwd" onblur="oldpwd1('${sessionScope.a.password}');"/>
                    <span style="color: red;" id="span1" class="login_error_info">*</span></td>
                </tr>
                <tr>
                    <td class="login_info" style="font-size: large;">新密码：</td>
                ...
                <tr>
                    <td class="login_info" style="font-size: large;">确认密码：</td>
                    <td colspan="2"><input type="password" class="width150" name="a.password" id="confirmpwd" onblur="confirmpwd1()"/>
                ...
                <tr>
                    ...
                    <td class="login_button" colspan="2">
                    	...
                    	<span class="required">${passwordmsg}</span></td>                
                </tr>
            </table>
            </div>
            </form>
