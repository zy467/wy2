                ...
                <div id="data">            
                    <table id="datalist" style="margin-top: 16px;">
                        ...
                        <tr>
						    ...
						    <td>
						    	<input type="button" value="${salary }" onclick="updatestatus('${a.username}','su')" style="font-size: xx-small;line-height:2px;padding: 0 10px;" class="button button-glow button-border button-rounded button-primary"/>
							</td>
			   			    <td>
